 ...
 *
 * Catatan: Keduanya bersumber dari data OpenStreetMap (OSM) dan gratis
 * digunakan.
 */
public interface NominatimApiService {
     ...
     *
     * Format URL:
     * /route/v1/driving/{lon_asal},{lat_asal};{lon_tujuan},{lat_tujuan}?overview=full&geometries=geojson&steps=false
     *
